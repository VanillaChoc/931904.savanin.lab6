    ...
    public class RepliesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Replies != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Replies'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Message,CreatedDate,AuthorName,ParentTopicId")] Reply reply)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Message,CreatedDate,AuthorName,ParentTopicId")] Reply reply)
        {
            if (id != reply.Id)
            {
                return NotFound();
